...
export SPECTRE_BUILD_DIR=/home/geoffrey/Codes/spectre/spectre-numerical-import/build
...
mpirun -np 2 --map-by ppr:1:node ./EvolveGeneralizedHarmonic +ppn 19 +pemap 0-18 +commap 19 --input-file KerrSchild.yaml
