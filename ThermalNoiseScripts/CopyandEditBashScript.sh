...
# This is a bash script will copy, edit, and submit thermal noise jobs. Its main function is to run 
# thermal noise simulations with different incident beam radii.

# This script will copy the necessary files over (around line 30) and edit them with the given parameters.

# Note: To have this script work, I have assumed that the names of the directories in which the 
# simulations will be run are named in the form c10_r0_####. If your directores do not have this form
# you may change that around line 45. 
