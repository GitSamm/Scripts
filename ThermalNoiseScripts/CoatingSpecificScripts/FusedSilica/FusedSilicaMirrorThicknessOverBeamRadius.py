...
data = np.genfromtxt("VaryBeamEnergy_FusedSilica.dat")
...
# silica substrate
# They don't usually need to be changed.
sigmaSub = 0.17
YoungModSub = 72.e9
# Loss angles of the coating.
# Recall for a substrate with a single coating
# phi_FusedSilica = 1.6e-6
# phi_Iso_Ta2O5 = 4.e-4
# phi_iso_AlGaAs = 2.5e-5
# phi_AlGaAs = 2.5 e-5
phiCoat = 1.6e-6
phiSub =  1.6e-6
# d is defined as the coating thickness
d = 6.83e-6
# These needs to be changed for each coating
# The values for these are listed in Table 1
# of the paper. 
# They are defined as the youngs modulus and the poisson ratio for the coating.
YoungModCoat = 72.e9
sigmaCoat = 0.17
# R is defined as the mirror radius
R = 12500.e-6


# This analytci equation is defined as either equation 42 or equation 43 in the paper
...
ax.set_title('Fused Silica Ccoating', fontsize=myTitleSize, color='k', y=1.04)
...
#fig.savefig('Trajectories_2.png')

fig.tight_layout()
pdf = PdfPages('VaryBeamNoise_FusedSilica_theoretical.pdf')
pdf.savefig()
pdf.close()
