...
export SPECTRE_BUILD_DIR=/home/geoffrey/Codes/spectre/spectre-kerrschild/build_orca0
#export RUN_DIR=/home/geoffrey/spectre_tests/Kerr/ExciseCube/
export SPECTRE_EXECUTABLE=EvolveGeneralizedHarmonic
export SPECTRE_INPUT_FILE=./KerrSchild.yaml

source ${SPECTRE_BUILD_DIR}/../support/Environments/ocean_orca0_gcc.sh
...
mpirun -np 40 --map-by ppr:1:node ./EvolveGeneralizedHarmonic +ppn 11 +pemap 0-10 +commap 11 --input-file KerrSchild.yaml
